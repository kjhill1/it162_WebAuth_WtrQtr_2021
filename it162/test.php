...
<head>
    ...
    <style type="text/css">
        ...
        * {padding:0; margin:0;}
        ...
        /* THIS IS COMMENTED OUT because styles are in forms.css.dateFeedback!!!!!!!!!!!!!!!!!!
...
<body>
	...
	<?php
        ...
        $toAddress = "kelly.hill1@seattlecentral.edu";  //place your/your client's email address here
        $toName = "Kelly Hill"; //place your client's name here
        $website = "Web Design Portal Contact Form";  //place NAME of your client's website
